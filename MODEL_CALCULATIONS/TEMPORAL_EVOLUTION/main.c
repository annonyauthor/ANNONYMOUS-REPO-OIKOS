...
Relevant input arguments for model DIFFUSION_HII_nD:
  ...
  .~$ ./ECO_1B1P_4 -y0 22 -y2 1 -HS 1 -HN 1 -HM 1 -HX 1 -HY 1 \
                   -n 2 -v0 0 -v1 1 -G0 1 -G1 2  \
                   -G2 1 -G3 0.0 -G4 100.0 -G5 1 -G6 0.0 -G7 1000000.0 \
                   -tn 100 -t0 0.0 -t1 100.0 -t4 0 -tR 10 -xn 0 -xN 50.0 \
                   -HK 1000000.0 -H4 0.6 -H1 0.2 -H3 0.1 -H2 10.0 \
                   -H9 0.5 -H10 0.2 \
                   -Hp1 0.01 -Hp2 0.3 -H11 0.1 \
                   -HuR 0.0 -HuC 0.0 -H0 0.0

  MODEL = DIFFUSION_ECO_1B1P_SELF (-y2 23)  
  Compiled as a model with self-competition induced mortality, with the same parameters as DIFFUSION_ECO_1B1P:

  .~$ make clean
  .~$ make MODEL=DIFFUSION_ECO_1B1P_SELF BT=NON_BINARY_TREE_SUPER_OPTIMIZATION STO=NON_STOCHASTIC_OPTIMIZATION RE=NON_REUSE_RANDOM_NUMBER
  
  .~$ ./DIFFUSION_ECO_1B1P_SELF -y0 23 -y2 1 -HS 1 -HN 1 -HM 1 -HX 1 -HY 1 \
                              -n 2 -v0 0 -v1 1 -G0 1 -G1 2 \
                              -G2 1 -G3 0.0 -G4 10.0 -G5 1 -G6 0.0 -G7 1000 \
                              -tn 100 -t0 0.0 -t1 10.0 -t4 0 -tR 10 -xn 0 -xN 50.0  \
                              -HK 1000 -H4 2.5 -H1 1.0 -H3 1.0 -H2 1.0\
  ...
  .~$ ./DIFFUSION_ECO_1B1P_SELF -y0 23 -y2 1 -HS 1 -HN 1 -HM 1 -HX 1 -HY 1 \
                            -n 2 -v0 0 -v1 1 -G0 1 -G1 2 \
                            -G2 1 -G3 0.0 -G4 10.0 -G5 1 -G6 0.0 -G7 1000 \
                            -tn 100 -t0 0.0 -t1 10.0 -t4 0 -tR 10 -xn 0 -xN 40.0 \
                            -HK 1000 -H4 8.5 -H1 0.1 -H3 0.25 -H2 1.0 \
                            -H9 0.8 -H10 0.4 \
                            -Hp1 0.0001 -Hp2 0.08 -H11 0.75 \
                            -HuR 0.0 -HuC 0.0 -H0 0.0
...
#include <gsl_random_number_Setup.c>
  ...
  if (Table.TYPE_of_MODEL == 21 || Table.TYPE_of_MODEL == 17 || Table.TYPE_of_MODEL == 18 || 
      ...
      Table.TYPE_of_MODEL == 23) {
    /* Stochastic Time Dynamics */
