...
-----  --------   --------------------
 0:   -HuR 0.0    Local Diffusion of Resources  (also -Hu)              
...
ECO_1B1P:
-HS  1      Number of Bacterial Strains
-HN  1      Number of Plasmids
-HM  1      Number of Local Populations
...
29:   -H20 5.0    Resource Establishment Rate (Eta_R, only DIFFUSION_STOLLENBERG_4D)
    ...
    . ~$ ./DIFFUSION_ECO_1B1P -y0 22 -y2 1 -HS 1 -HN 1 -HM 1 -HX 1 -HY 1 \
                                     -G0 1 -G1 1 \
                                     -sT 1.0E-06 -sN 300 -sP 2 \
                                     -I1 11 -m1 0.0001 -M1 10.0 -A1 0.01 -d1 1000 \
                                     -I0 7  -m0 0.0001 -M0 2.0 -A0 0.01 -d0 1000 \
                                    -iP 0 -en 0  \
                                    -HuR 0.0 -HuC 0.0 -H0 0.0 \
                                    -HK 500 -H4 2.5 -H1 0.1 -H3 0.5 -H2 1.0 \
                                    -H9 0.1 -H10 0.5 \
                                    -Hp1 0.01 -Hp2 0.3 -H11 0.1
    ...
    .~$ ./DIFFUSION_ECO_1B1P_SELF -y0 23 -y2 1 -HS 1 -HN 1 -HM 1 -HX 1 -HY 1 \
                                  -G0 1 -G1 1 \
                                  -sT 1.0E-06 -sN 300 -sP 2 \
                                  -I1 11 -m1 0.0001 -M1 10.0 -A1 0.01 -d1 500 \
                                  -I0 7  -m0 0.0001 -M0 2 -A0 0.01 -d0 500 \
                                  -iP 0 -en 0  \
                                  -HuR 0.0 -HuC 0.0 -H0 0.0 \
...
#include <gsl_random_number_Setup.c>
  ...
  */
  ...
  int Status =  generic_Function_Parameter_2Dim_Scan_Improved(&Table, 
							                                                No_of_POINTS_1, Input_Parameter_1,
							                                                No_of_POINTS_2, Input_Parameter_2,
							                                                Calculate_Type_of_Coexistence,   // Function_to_Type_of_Stability, 
